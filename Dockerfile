...
ADD https://raw.githubusercontent.com/NetherKids/steamcmd/master/manage/query.py /opt/manage/query.py
ADD https://raw.githubusercontent.com/NetherKids/steamcmd/master/manage/rcon.py /opt/manage/rcon.py

HEALTHCHECK  --interval=60s --timeout=60s CMD python3 /opt/manage/query.py localhost ${QUERYPORT}
