...
ADD --chown=$USER:$GROUP https://raw.githubusercontent.com/NetherKids/ServerManagement/main/query.py /opt/query.py
ADD --chown=$USER:$GROUP https://raw.githubusercontent.com/NetherKids/ServerManagement/main/rcon.py /opt/rcon.py
